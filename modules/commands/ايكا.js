module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "Teri",
  description: "صور عشوائية أياكا",
  commandCategory: "صــــــــورة🌠",
  usages: "أياكا",
  usePrefix:true,
  cooldowns: 5,
  dependencies: {
...
var min = Math.floor(Math.random() * 2);
  ...
  var money = data.money
      if(money < 0) api.sendMessage("تحتاج إلى  $1000 من أحل رؤية الصور?",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 0})
   var callback = () => api.sendMessage({body:`صور أياكا من أحلك 💞 ${link.length}\n-100 تم خصم!`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"), event.messageID); 
