module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "عمر",
    description: "حضن شخص بتاغ أو بالرد 🥰",
...
module.exports.run = async function ({ event, api, args }) {    
    ...
    // إذا رد على رسالة استخدم senderID للشخص المرسل الأصلي
    const two = messageReply ? messageReply.senderID : Object.keys(event.mentions)[0];

    if (!two) return api.sendMessage("منشن شخص أو رد على رسالته لأرسل له حضن 🥰", threadID, messageID);
